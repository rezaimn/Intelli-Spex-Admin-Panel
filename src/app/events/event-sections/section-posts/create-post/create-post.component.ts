...
export class CreatePostComponent implements OnInit {
    ...
    addPost() {
        ...
        body.append('eventId', this.selectedEvent.toString());
        body.append('sectionId', this.selectedSection.toString());
        ...
        this.service.addPost(body).subscribe(result => {
                if (result.status === 200) {
                    ...
                    this.router.navigate(['/events/section-posts/'+this.selectedEvent+'/'+this.selectedSection]);
                }
            }
        );
    }
